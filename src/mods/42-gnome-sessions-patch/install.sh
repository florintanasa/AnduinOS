...
sed -i 's/Ubuntu/BRGV-OS/g' /usr/share/gnome-session/sessions/ubuntu.session
judge "Set up /usr/share/gnome-sessions/sessions"

print_ok "Setting up /usr/share/xsessions..."
rm /usr/share/xsessions/gnome* || true

mv /usr/share/xsessions/ubuntu.desktop /usr/share/xsessions/brgvos.desktop
mv /usr/share/xsessions/ubuntu-xorg.desktop /usr/share/xsessions/brgvos-xorg.desktop
sed -i 's/Name=Ubuntu/Name=BRGV-OS/g' /usr/share/xsessions/brgvos.desktop
sed -i 's/Name=Ubuntu/Name=BRGV-OS/g' /usr/share/xsessions/brgvos-xorg.desktop
judge "Set up /usr/share/xsessions"

print_ok "Setting up /usr/share/wayland-sessions..."
rm /usr/share/wayland-sessions/gnome* || true

mv /usr/share/wayland-sessions/ubuntu.desktop /usr/share/wayland-sessions/brgvos.desktop
mv /usr/share/wayland-sessions/ubuntu-wayland.desktop /usr/share/wayland-sessions/brgvos-wayland.desktop
sed -i 's/Name=Ubuntu/Name=BRGV-OS/g' /usr/share/wayland-sessions/brgvos.desktop
sed -i 's/Name=Ubuntu/Name=BRGV-OS/g' /usr/share/wayland-sessions/brgvos-wayland.desktop
